...
class Scratch3MotionBlocks {
    ...
    scrollRight (args, util) {
        stage.scrollX += Cast.toNumber(args.DISTANCE);
    }
    scrollUp (args, util) {
        stage.scrollY += Cast.toNumber(args.DISTANCE);
    }
    alignScene (args, util) {
        stage.scrollX = 0;
        stage.scrollY = 0;
    }
    xScroll (args, util) {
        return stage.scrollX;
    }
    yScroll (args, util) {
        return stage.scrollY;
    }
    moveSteps (args, util) {
