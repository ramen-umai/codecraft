...
class ScriptTreeGenerator {
    ...
    descendInput (block, preserveStrings = false) {
        ...
        case 'motion_xScroll':
            return new IntermediateInput(InputOpcode.MOTION_SCROLL_X_GET, InputType.NUMBER);
        case 'motion_yScroll':
            return new IntermediateInput(InputOpcode.MOTION_SCROLL_Y_GET, InputType.NUMBER);
        case 'operator_add':
        ...
        case 'operator_or':
            return new IntermediateInput(InputOpcode.OP_OR, InputType.BOOLEAN, {
                left: this.descendInputOfBlock(block, ' OPRAND1').toType(InputType.BOOLEAN),
                right: this.descendInputOfBlock(block, 'OPERAND2').toType(InputType.BOOLEAN)
        });
